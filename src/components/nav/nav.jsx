    ...
    render() {
        return (
            <div>
                    ...
                    <a className="navbar-brand" href="https://github.com/Bawanthathilan">
                    <svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-archive-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
